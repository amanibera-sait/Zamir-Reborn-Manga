  ...
  return (
    <div className='my-5'>
        ...
        <div className='flex flex-col justify-center items-center text-lg'>
            ...
            <div className='flex flex-col justify-center relative bg-gray-200 p-4 mb-20'>
                <div className=''>
                    <BannerCarousel/>
                </div>
                <p className='w-1/3 m-36 p-10 absolute text-2xl font-bold rounded bg-gray-800 text-white bg-opacity-75 bg-auto drop-shadow-md'>{ZamirRebornJSON.synopsis}</p>
            </div>
            <div className="flex justify-center my-6 w-3/4">
            ...
            <div className="flex flex-col w-1/2 rounded bg-gray-200 bg-auto m-4 p-6 text-4x1 space-y-12 drop-shadow-md">
